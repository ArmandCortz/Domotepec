...
<div class="mt-2">
    ...
    <section class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
                    <h1 style="color: #020202;line-height: 50px;text-align: center" class="vc_custom_heading">Galería</h1>
                    <p style="color: #050505;text-align: center" class="vc_custom_heading vc_custom_1491259691992">Conoce más detalles sobre Domotepec</p>
                <div class="card-body">
                  <div class="row">
