<div class="modal fade" id="crearSucursalModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="crearSucursalModalLabel" aria-hidden="true" >
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('sucursales.store') }}">
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        ...
                        <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ old('nombre') }}" required autocomplete="nombre" autofocus placeholder="Nombre de la Sucursal">
                        @error('nombre')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        ...
                        <input type="text" class="form-control @error('direccion') is-invalid @enderror" id="direccion" name="direccion" value="{{ old('direccion') }}" required autocomplete="direccion" placeholder="Dirección">
                        @error('direccion')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        ...
                        <input type="text" class="form-control @error('gerente') is-invalid @enderror" id="gerente" name="gerente" value="{{ old('gerente') }}" required autocomplete="gerente" placeholder="Gerente">
                        @error('gerente')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
