<div class="modal fade" id="modal-eliminar-{{ $empresa->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input id="nombre" type="text"
                                            ...
                                            value="{{ $empresa->nombre }}" autocomplete="nombre" autofocus disabled>
