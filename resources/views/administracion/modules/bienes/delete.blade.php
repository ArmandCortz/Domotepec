<div class="modal fade" id="modal-eliminar-{{ $bien->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
                ...
                <div class="container">
                    <div class="card-body">
                        <h5 class="text-center" style="color: red">
                            ¿Estas seguro de querer eliminar el bien
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input id="nombre" type="text"
                                            ...
                                            value="{{ $bien->nombre }}" autocomplete="nombre" autofocus disabled>
                                        ...
                                        <select id="sucursal" name="sucursal"
                                            ...
                                            @foreach ($sucursales as $sucursal)
                                                <option value="{{ $sucursal->id }}"
                                                    {{ $sucursal->id == $bien->sucursal ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <input id="costo" type="number"
                                                ...
                                                value="{{ $bien->costo }}" step="0.01" min="0.01"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <input id="stock" type="number"
                                                    ...
                                                    value="{{ $bien->stock }}" autocomplete="stock" autofocus disabled>
                                                @error('stock')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <textarea id="descripcion" class="form-control @error('descripcion') is-invalid @enderror" name="descripcion"
                                            rows="6" autocomplete="descripcion" disabled autofocus placeholder="Escribe una descripcion para el servicio">{{ $bien->descripcion }}</textarea>
