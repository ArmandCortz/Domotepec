                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <select id="cabaña" name="cabaña"
                                                ...
                                                <option value="" selected disabled>Selecciona una cabaña

                                                    @foreach ($cabañas as $cabaña)
                                                <option value="{{ $cabaña->id }}">{{ $cabaña->nombre }} </option>
                                                @endforeach
                                ...
                                <div class="col">
                                    <div class="row mb-3">
                                        <label for="fecha_entrada"
                                            class="col-md-4 col-form-label text-md-end">{{ __('Fecha de ingreso') }}</label>
                                        <div class="col-md-8">
                                ...
                                <div class="col">
                                    <div class="row mb-3">
                                        <label for="fecha_salida"
                                            class="col-md-4 col-form-label text-md-end">{{ __('Fecha de egreso') }}</label>
                                        <div class="col-md-8">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input id="precio" type="number"
                                                    ...
                                                    name="precio" autocomplete="precio" step="0.01" min="0.01"
                                                    autofocus>
                                                @error('precio')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                ...
                                                <input id="limpieza" type="number"
                                                    ...
                                                    name="limpieza" autocomplete="limpieza" step="0.01"
                                                    min="0.01" autofocus>
                                                @error('limpieza')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
