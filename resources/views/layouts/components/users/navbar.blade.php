<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
        ...
        <a class="navbar-brand" href="{{ route('Inicio') }}">Domotepec</a>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a href="{{ route('Inicio') }}" class="nav-link"
                        style="font-size: 18px; margin-right: 15px;">Inicio</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('Servicios') }}" class="nav-link"
                        style="font-size: 18px; margin-right: 15px;">Servicios</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('galerias.indexs') }}"
                        style="font-size: 18px; margin-right: 15px;">Galería</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('Contacto') }}" class="nav-link"
                        style="font-size: 18px; margin-right: 15px;">Contacto</a>
                </li>
            </ul>
        </div>
    </div>
