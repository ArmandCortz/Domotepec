                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="fecha_salida" name="fecha_salida"
                                                required value="{{ date('Y-m-d', strtotime($reserva->fecha_salida)) }}"
                                                disabled>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nombres" id="nombres"
                                                value="{{ $reserva->nombres }}" disabled>
                                        </div>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="apellidos" id="apellidos"
                                                value="{{ $reserva->apellidos }}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row row-cols-2">
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="huespedes" id="huespedes"
                                                min="1" value="{{ $reserva->huespedes }}"
                                                max="{{ $cabana->huespedes }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col">
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" name="telefono" id="telefono"
                                        placeholder="Ejemplo: 50309876543" value="{{ $reserva->telefono }}" disabled>
                                </div>



                                <a type="button" class="btn btn-outline-primary mb-2" href="{{ route('Inicio') }}"
                                    style="width: 100%">Inicio</a>
                                <p class="text-center">Nos contactaremos con tigo en un lapso de 15 min para confirmar la
                                    reserva</p>
