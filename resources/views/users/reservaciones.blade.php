                ...
                <div class="row">
                    @foreach ($cabanas as $cabana)
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <img src="{{ asset('img/cabanas/' . $cabana->imagen) }}" class="card-img-top"
                                    alt="{{ $cabana->nombre }}">
                                <div class="card-body">
                                    ...
                                    {{-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#reservaModal" data-cabana-nombre="{{ $cabana->nombre }}" data-cabana-descripcion="{{ $cabana->descripcion }}">Reservar</button> --}}
                                    <a href="{{ route('reservaciones.cabana', $cabana->id) }}"
                                        class="btn btn-outline-primary ver-cabana" style="width: 100%"
                        ...
                        <form action="index.html" method="get" class="tm-search-form tm-section-pad-2">
                            <div class="form-row tm-search-form-row">
                                ...
                                <div class="form-group tm-form-element tm-form-element-50">
                                    ...
                                    <input name="check-in" type="date" class="form-control" id="inputCheckIn"
                                ...
                                <div class="form-group tm-form-element tm-form-element-50">
                                    ...
                                    <input name="check-out" type="date" class="form-control" id="inputCheckOut"
                            ...
                            <div class="form-row clearfix pl-2 pr-2 tm-fx-col-xs">
                                <a href="#"
                                    class="ie-10-ml-auto ml-auto mt-1 tm-font-semibold tm-color-primary">¿Necesitas
                                    ayuda?</a>
                            </div>
                        </form>
                    </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#reservaModal').on('show.bs.modal', function(event) {
                    ...
                    // Actualiza el contenido de la modal con la información de la cabana
                    var modal = $(this);
