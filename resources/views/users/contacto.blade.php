...
@section('content')
    <div class="container text-center  mb-3">
        <h3>Contacto </h3>
        <p>Estamos para resolver todas tus dudas y escuchar tus comentarios, por favor cualquier detalle no dudes en
            escribirnos y te contestaremos lo más pronto posible.</p>
                ...
                <section id="contacto" class="mt-5">
                    <div class="container contenedor-form">
                        ...
                        <form action="" id="contact-form">
                            ...
                            <button type="button" id="enviar" class="btn btn-primary btn-enviar">Enviar Mensaje
                            </button>
                        </form>
                    </div>
                </section>
                ...
                <section id="mapa" class="mt-5">
                    ...
                    <div id="mapa">
                        ...
                        <iframe
                            ...
                            width="100%" height="361px" style="border:0.5;" allowfullscreen="" loading="lazy">
                        </iframe>
