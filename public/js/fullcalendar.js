...
var FullCalendar = (function (e) {
            ...
            e: if ("function" == typeof _) {
                if (
                    ...
                    null != u.componentWillUpdate &&
                        u.componentWillUpdate(b, u.__s, S),
    ...
    function j(e, t, r) {
        ...
        if (
            ...
            (i = e.ref) &&
                ((i.current && i.current !== e.__e) || B(i, null, t)),
            null != (i = e.__c))
        ) {
    ...
    (n.unmount = function (e) {
        ...
        (ae.prototype.render = function (e, t) {
            ...
            return (
                i && (i.__h = null), [p(y, null, t.__a ? null : e.children), i]
            );
        });
            ...
            for (var s in ((r = {}), n)) {
                ...
                (me && "children" === s && "noscript" === t) ||
                    ...
                    ("defaultValue" === s && "value" in n && null == n.value
                        ...
                        ? (s = "ondblclick")
                        : /^onchange(textarea|input)/i.test(s + t) &&
                          !ve(n.type)
                        ? (s = "oninput")
                        : /^onfocus$/i.test(s)
                        ? (s = "onfocusin")
    ...
    function it(e, t, n) {
        return n.func
            ? n.func(e, t)
            : st(e[n.field], t[n.field]) * (n.order || 1);
    }
    function st(e, t) {
        return e || t
            ? null == t
    ...
    class qn extends Gn {
        constructor() {
            super(...arguments),
                ...
                (this.handleEl = (e) => {
                    ...
                    (t.customRenderingReplaces && Yn(n, t)) ||
                        this.updateElRef(e);
                }),
                (this.updateElRef = (e) => {
        ...
        triggerCustomRendering(e) {
            ...
            const { props: n, context: r } = this,
                { handleCustomRendering: i, customRenderingMetaMap: s } =
                    r.options;
            if (i) {
                const r =
    ...
    class gr {
        ...
        buildRangeFromDuration(e, t, n, r) {
            ...
            return (
                ...
                c(),
                this.trimHiddenDays(o) ||
                    ((e = this.skipHiddenDays(e, t)), c()),
                o
            );
        }
            ...
            (function (e) {
                ...
                t =
                    !0 === e
                        ...
                        : [];
                return (
                    (t = t.map((e) => Object.assign(Object.assign({}, Qr), e))),
                    t
                );
            })(e),
            null,
                ...
                ("inverse-background" === u.display
                    ...
                    : "none" !== u.display &&
                      ("background" === u.display ? a : l).push({
                          ...
                          isStart:
                              f.start &&
                              f.start.valueOf() === g.start.valueOf(),
        ...
        addEvent(e, t) {
            ...
            if (i) {
                let e = new ti(
                    r,
                    i.def,
                    i.def.recurringDef ? null : i.instance
                );
                return (
    ...
    class Wi {
        ...
        splitProps(e) {
            let t = this.getKeyInfo(e),
                ...
                l = {};
            this.eventUiBuilders = An(
                t,
                (e, t) => this.eventUiBuilders[t] || Gt(Li)
            );
            for (let n in t) {
                let c = t[n],
                    d = s[n] || Ui,
                ...
                l[n] = {
                    ...
                    eventSelection: d.instances[e.eventSelection]
                        ? e.eventSelection
                        : "",
                    eventDrag: o[n] || null,
    ...
    class cs {
        ...
        isInsertionValid(e, t) {
            return (
                (-1 === this.maxCoord ||
                    e.levelCoord + this.getEntryThickness(t) <=
                        this.maxCoord) &&
    ...
    class Cs extends Gn {
        render() {
            let { props: e } = this,
                ...
                l = Object.assign(
                    Object.assign(
                        Object.assign(Object.assign({ date: s }, o), {
                            view: r,
                        }),
                        e.extraRenderProps
                    ),
                ...
                !(function (e, t, n, r) {
                    ...
                    for (let r in l) {
                        let o = l[r],
                            ...
                            p = c[o.defId],
                            m = a[o.defId];
                        if (!js(p.constraints, g, d, e.businessHours, t))
                            return !1;
                ...
                !(function (e, t, n, r) {
                    ...
                    for (let e in o) {
                        ...
                        if (or(l, n.range)) {
                            ...
                            if (u && !u(new ti(t, s[n.defId], n), null))
                                return !1;
                        }
                    }
    ...
    class io extends Gn {
        constructor() {
            super(...arguments),
                ...
                (this.scrollerElRefs = new Vs(
                    this._handleScrollerEl.bind(this)
                )),
                (this.state = {
                    shrinkWidth: null,
                    forceYScrollbars: !1,
            ...
            let { props: i } = this,
                ...
                h = Ys(
                    ...
                    n,
                    {
                        ...
                        tableMinWidth: "",
                        clientWidth:
                            i.collapsibleWidth || void 0 === o[u] ? null : o[u],
        ...
        render() {
            ...
            return p(
                ...
                Object.assign({}, e, {
                    ...
                    defaultGenerator: e.defaultGenerator,
                    classNameGenerator: r.isDisabled
                        ? void 0
                        : n.dayCellClassNames,
    ...
    function fo(e) {
        ...
        return Object.assign(
            Object.assign(
                Object.assign({ date: n.toDate(t), view: e.viewApi }, s),
                { isMonthStart: i, dayNumberText: o }
            ),
            e.extraRenderProps
        );
    }
            ...
            return fe(
                p(
                    ...
                    p(
                        ...
                        p("span", {
                            className:
                                "fc-popover-close " + e.getIconClass("close"),
                            title: t.closeHint,
        ...
        updateSize() {
            ...
            if (i) {
                let s = r.getBoundingClientRect(),
                    o = n
                        ? Oe(t, ".fc-scrollgrid").getBoundingClientRect().top
                        : i.top,
    ...
    class So extends Gn {
        ...
        updateParentEl() {
            this.linkEl &&
                (this.parentEl = Oe(this.linkEl, ".fc-view-harness"));
        }
    }
    function Ao(e) {
        return e.text;
    ...
    function Do(e) {
        if (e.allDayDate)
            return { start: e.allDayDate, end: wt(e.allDayDate, 1) };
        let { hiddenSegs: t } = e;
        return {
            start: wo(t),
        ...
        _o = {
            ...
            cloneElement: function (e, n, r) {
                ...
                return (
                    arguments.length > 2 &&
                        (a.children =
                            arguments.length > 3 ? t.call(arguments, 2) : r),
                            ...
                            void 0 === a
                                ? ((n[e] = o.id),
                                  ...
                                  (r = {
                                      ...
                                      isLoadingFuncs: t.isLoadingFuncs.concat(
                                          s.isLoadingFuncs
                                      ),
                                      contextInit: t.contextInit.concat(
                                          s.contextInit
                                      ),
                                      ...
                                      isDraggableTransformers:
                                          t.isDraggableTransformers.concat(
                                      ...
                                      eventDefMutationAppliers:
                                          t.eventDefMutationAppliers.concat(
                                      ...
                                      datePointTransforms:
                                          t.datePointTransforms.concat(
                                              s.datePointTransforms
                                          ),
                                      dateSpanTransforms:
                                          t.dateSpanTransforms.concat(
                                              s.dateSpanTransforms
                                          ),
                                      views: Object.assign(
                                          Object.assign({}, t.views),
                                          s.views
                                      ),
                                      viewPropsTransformers:
                                          t.viewPropsTransformers.concat(
                                              s.viewPropsTransformers
                                          ),
                                      isPropsValid:
                                          s.isPropsValid || t.isPropsValid,
                                      externalDefTransforms:
                                          t.externalDefTransforms.concat(
                                              s.externalDefTransforms
                                          ),
                                      viewContainerAppends:
                                          t.viewContainerAppends.concat(
                                              s.viewContainerAppends
                                          ),
                                      eventDropTransformers:
                                          t.eventDropTransformers.concat(
                                              s.eventDropTransformers
                                          ),
                                      calendarInteractions:
                                          t.calendarInteractions.concat(
                                              s.calendarInteractions
                                          ),
                                      componentInteractions:
                                          t.componentInteractions.concat(
                                      ...
                                      cmdFormatter:
                                          s.cmdFormatter || t.cmdFormatter,
                                      recurringTypes: t.recurringTypes.concat(
                                          s.recurringTypes
                                      ),
                                      namedTimeZonedImpl:
                                      ...
                                      initialView:
                                          t.initialView || s.initialView,
                                      elementDraggingImpl:
                                          t.elementDraggingImpl ||
                                          s.elementDraggingImpl,
                                      ...
                                      scrollGridImpl:
                                          s.scrollGridImpl || t.scrollGridImpl,
            ...
            (e) =>
                (function (e, t, n, r, i) {
                    ...
                    return {
                        ...
                        buttonTextOverride:
                            d(r) || d(n) || e.overrides.buttonText,
                        buttonTextDefault:
                            d(i) || e.defaults.buttonText || d(cn) || e.type,
                        buttonTitleOverride:
                            u(r) || u(n) || e.overrides.buttonHint,
                        buttonTitleDefault:
                            u(i) || e.defaults.buttonHint || u(cn),
                    };
                })(e, s, t, n, r)
        );
    }
    ...
    function Qo(e, t, n, r) {
        ...
        switch (t.type) {
            ...
            case "REMOVE_EVENT_SOURCE":
                return (
                    (s = e), (o = t.sourceId), Sn(s, (e) => e.sourceId !== o)
                );
            case "PREV":
            case "NEXT":
            case "CHANGE_DATE":
            ...
            o.fetch(
                ...
                (n) => {
                    ...
                    i.eventSourceSuccess &&
                        ...
                        e.success &&
                            (o = e.success.call(s, o, n.response) || o),
                        r.dispatch({
                            type: "RECEIVE_EVENTS",
                            sourceId: e.sourceId,
                            fetchId: a,
                ...
                (n) => {
                    ...
                    i.eventSourceFailure &&
                        (i.eventSourceFailure.call(s, n), (o = !0)),
            ...
            widgets: h.map((e) =>
                e.split(",").map((e) => {
                    ...
                    if ((n = a[e]))
                        ...
                        y = at(
                            h.buttonTitleOverride ||
                                h.buttonTitleDefault ||
                                t.viewHint,
                            [n, e],
                            n
                        );
            ...
            eventSourceDefs: [
                {
                    ignoreRange: !0,
                    parseMeta: (e) =>
                        Array.isArray(e.events) ? e.events : null,
                    fetch(e, t) {
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        Object.assign(
                            Object.assign({}, Di(e.activeRange, t.dateEnv)),
                            { view: t.viewApi }
                        )
                    );
                },
    ...
    class ha {
        ...
        _handleAction(e) {
            ...
            let u = Qo(n.eventSources, e, d, l),
                ...
                f =
                    ...
                    h,
                { eventUiSingleBase: g, selectionConfig: p } =
        ...
        updateData() {
            ...
            if (a && a !== l) {
                ...
                for (let e in o)
                    (-1 === this.optionsForHandling.indexOf(e) &&
                        a[e] === l[e]) ||
                        o[e](l[e], s);
            }
        ...
        processRawCalendarOptions(e, t) {
            let { locales: n, locale: r } = mn([cn, e, t]),
                ...
                l = (this.currentCalendarOptionsRefiners = Object.assign(
                    Object.assign(
                        Object.assign(
                            Object.assign(Object.assign({}, ln), dn),
                            un
                        ),
                        a.listenerRefiners
                    ),
            ...
            for (let e in s)
                s[e] === l[e] || (hn[e] && hn[e](s[e], l[e]))
                    ...
                    : (s[e] === this.currentCalendarOptionsInput[e] ||
                      (hn[e] &&
                          hn[e](s[e], this.currentCalendarOptionsInput[e]))
    ...
    function Ma(e) {
        ...
        return new Hn(
            Object.assign(
                Object.assign(
                    { timeZone: cn.timeZone, calendarSystem: "gregory" },
                    e
                ),
                { locale: t }
            )
    ...
    class Pa {
        constructor(e) {
            (this.subjectEl = null),
                ...
                (Oa += 1),
                1 === Oa &&
                    window.addEventListener("touchmove", Ha, { passive: !1 });
        }
        destroy() {
            this.containerEl.removeEventListener(
                ...
                (Oa -= 1),
                Oa ||
                    window.removeEventListener("touchmove", Ha, {
                        passive: !1,
                    });
        }
        tryStart(e) {
            ...
            super(),
                (this.handleScroll = () => {
                    (this.scrollTop = this.scrollController.getScrollTop()),
                        (this.scrollLeft =
                            this.scrollController.getScrollLeft()),
        ...
        constructor(e, t) {
            (this.useSubjectCenter = !1),
                ...
                (this.handleDragEnd = (e) => {
                    this.movingHit &&
                        this.emitter.trigger("hitupdate", null, !0, e),
    ...
    function qa(e, t) {
        return (
            (!e && !t) ||
            (Boolean(e) === Boolean(t) && Ai(e.dateSpan, t.dateSpan))
        );
    }
    function Ya(e, t) {
        let n = {};
            ...
            super(e),
                ...
                (this.handlePointerDown = (e) => {
                    ...
                    let a = (this.subjectSeg = ai(e.subjectEl)),
                        l = (this.eventRange = a.eventRange).instance
                            .instanceId;
                    (this.relevantEvents = xr(
                        o.getCurrentData().eventStore,
                        l
                    )),
                        (r.minDistance = e.isTouch
                            ? 0
                    ...
                    let c =
                        n.isValidSegDownEl(t) && !Oe(t, ".fc-event-resizer");
                    r.setIgnoreMove(!c),
                        (this.isDragging =
                            c &&
                    ...
                    if (e) {
                        ...
                        i === s || (t.editable && t.droppable)
                            ? ((o = (function (e, t, n) {
                                  ...
                                  r,
                                  e,
                                  s.getCurrentData().pluginHooks
                                      .eventDragMutationMassagers
                              )),
                              o &&
                                  ((a = $r(
                                      n,
                                      s.getCurrentData().eventUiBases,
                                      o,
                                      s
                                  )),
                                  (c.mutatedEvents = a),
                ...
                constructor(e) {
                    super(e),
                        (this.handlePointerDown = (e) => {
                            ...
                            t.setIgnoreMove(
                                !this.component.isValidDateDownEl(n)
                            );
                        }),
                        (this.handleDragEnd = (e) => {
                            let { component: t } = this,
                    ...
                    super(e),
                        ...
                        (this.handlePointerDown = (e) => {
                            let { component: t, dragging: n } = this,
                                ...
                                i =
                                    r.selectable &&
                                    t.isValidDateDownEl(e.origEvent.target);
                            n.setIgnoreMove(!i),
                                (n.delay = e.isTouch
                                    ? (function (e) {
                                          let { options: t } = e.context,
                            ...
                            if (e) {
                                ...
                                (e.componentId === t.componentId &&
                                    ...
                                    (r = (function (e, t, n) {
                                        ...
                                        t,
                                        e,
                                        n.pluginHooks.dateSelectionTransformers
                                    )),
                                    (r && Ps(r, e.dateProfile, n)) ||
                                        ((i = !0), (r = null));
                            }
                            r
                                ? n.dispatch({
            ...
            class extends Mi {
                constructor(e) {
                        ...
                        (this.handlePointerDown = (e) => {
                            ...
                            (this.dragging.minDistance =
                                ...
                                this.dragging.setIgnoreMove(
                                    !this.component.isValidSegDownEl(
                                        e.origEvent.target
                                    ) ||
                                        (e.isTouch &&
                            ...
                            if (
                                ...
                                t.emitter.trigger(
                                    ...
                                    Object.assign(Object.assign({}, l), {
                                        el: this.draggingSegEl,
                                        startDelta:
                                            this.validMutation.startDelta ||
                                            ft(0),
                                        endDelta:
                                            this.validMutation.endDelta ||
                                            ft(0),
                                        jsEvent: e.origEvent,
                                        view: t.viewApi,
                                    })
                    ...
                    (n.pointer.selector = ".fc-event-resizer"),
                        ...
                        (n.autoScroller.isEnabled =
                            t.context.options.dragScroll);
            ...
            return p(
                ...
                (s, a) =>
                    p(
                        ...
                        !a.isDisabled &&
                            (t.showDayNumber || ho(i) || t.forceDayTop)
                            ? p(
                                  "div",
                            ...
                            (function (e, t) {
                                ...
                                let n = (function (e) {
                                    ...
                                    for (let n of e)
                                        for (let e of n)
                                            t[
                                                e.seg.eventRange.instance.instanceId
                                            ] = e.absoluteTop;
                                    return t;
                                })(t);
                                return e.map((e) => ({
            ...
            if (c)
                for (let e of t) {
                    ...
                    m &&
                        (a.isRtl
                            ? ((y = 0),
                              (v = c.lefts[t.lastCol] - c.lefts[t.firstCol]))
                            : ((v = 0),
                              (y =
                                  c.rights[t.firstCol] - c.rights[t.lastCol]))),
                        h.push(
                            p(
                                "div",
                                {
                                    ...
                                    ref: u
                                        ? null
                                        : this.segHarnessRefs.createRef(ml(t)),
                                    style: {
                                        visibility: g ? "" : "hidden",
            ...
            if (this.needsScrollReset && this.props.clientWidth) {
                const e = (function (e, t) {
                    ...
                    t.currentRangeUnit.match(/year|month/) &&
                        (n = e.querySelector(
                            `[data-date="${Lt(t.currentDate)}-01"]`
                        ));
                    n ||
                        (n = e.querySelector(
                            `[data-date="${Wt(t.currentDate)}"]`
                        ));
                    return n;
        ...
        views: {
            dayGrid: {
                component: class extends tl {
                    ...
                    render() {
                        let { options: e, dateProfileGenerator: t } =
                                this.context,
                            { props: n } = this,
                    ...
                    h.push({
                        ...
                        outerContent: p(
                            ...
                            p("td", {
                                ...
                                className:
                                    "fc-timegrid-divider " +
                                    l.theme.getClass("tableCellShaded"),
                            })
                        ),
                    }));
    ...
    class jl {
        ...
        computeTimeTop(e) {
            let t,
                ...
                s = r.els.length,
                o =
                    (e.milliseconds - yt(i.slotMinTime)) /
                    yt(this.slotDuration);
            return (
                (o = Math.max(0, o)),
                (o = Math.min(s, o)),
                (t = Math.floor(o)),
            ...
            let {
                ...
                { segPlacements: b, hiddenGroups: E } = (function (e, t, n, r) {
                    ...
                    for (let n = 0; n < e.length; n += 1) {
                        let r = t[n];
                        r
                            ? i.push({ index: n, thickness: 1, span: r })
                            : s.push(e[n]);
                    }
                ...
                p(
                    ...
                    Object.assign(
                        ...
                        this.slicer.sliceProps(e, n, null, t, o),
                        {
                            ...
                            nowDate: a,
                            nowIndicatorSegs:
                                i && this.slicer.sliceNowDate(a, n, s, t, o),
                            todayRange: l,
                ...
                component: class extends ls {
                    constructor() {
                        super(...arguments),
                            ...
                            (this.eventStoreToSegs = Gt(
                                this._eventStoreToSegs
                            )),
                            (this.state = {
                                timeHeaderId: We(),
                                eventHeaderId: We(),
                            ...
                            (this.setRootEl = (e) => {
                                e
                                    ? this.context.registerInteractiveComponent(
                                          this,
                                          { el: e }
                                      )
                                    : this.context.unregisterInteractiveComponent(
                                          this
                                      );
                            });
                    }
                    render() {
                        let { props: e, context: t } = this,
                            { dayDates: n, dayRanges: r } =
                                this.computeDateVars(e.dateProfile),
                            i = this.eventStoreToSegs(
                                e.eventStore,
                                e.eventUiBases,
                                r
                            );
                        return p(
                            ...
                            p(
                                Fs,
                                {
                                    ...
                                    overflowX: e.isHeightAuto
                                        ? "visible"
                                        : "hidden",
                                    overflowY: e.isHeightAuto
                                        ? "visible"
                                        : "auto",
                                },
                                i.length > 0
                    ...
                    renderSegList(e, t) {
                        ...
                        return p(Rs, { unit: "day" }, (e, l) => {
                            ...
                            return p(
                                ...
                                {
                                    className:
                                        "fc-list-table " + n.getClass("table"),
                                },
                                p(
                                    "thead",
                                    null,
                ...
                component: class extends ls {
                    ...
                    render() {
                        const { context: e, props: t, state: n } = this,
                            ...
                            h = this.buildMonthFormat(
                                r.multiMonthTitleFormat,
                                u
                            ),
                            f = [
                                "fc-multimonth",
                    ...
                    flushScrollReset() {
                        if (
                            ...
                            (t.scrollTop =
                                ...
                                this.firstMonthElRef.current.getBoundingClientRect()
                                    .top),
                                (this.needsScrollReset = !1);
                        }
                    }
                    ...
                    (this.handleData = (e) => {
                        (this.currentData = e),
                            this.renderRunner.request(
                                e.calendarOptions.rerenderDelay
                            );
                    }),
